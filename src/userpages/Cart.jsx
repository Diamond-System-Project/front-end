          ...
          <div className="flex justify-between">
            <div className="w-2/3">
              {cartItems.map((item) => (
                ...
                >
                  <img src={item.url} alt={item.name} className="w-36 h-36" />
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="quantity flex items-center">
                        <div className="custom-input-number flex items-center">
                          <button
                            className="decrement-btn px-2 py-1 border-0 rounded-l focus:outline-none"
                            onClick={() =>
                          ...
                          <InputNumber
                            ...
                            className="text-center border-t border-b border-gray-300 w-14 "
                            controls={false}
                          />
                          <button
                            className="increment-btn px-2 py-1 border-0 rounded-r focus:outline-none"
                            onClick={() =>
                              handleQuantityChange(item, item.quantity + 1)
                            }
                          >
