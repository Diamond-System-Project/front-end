...
import { Input, Select, Button, Card, Breadcrumb } from "antd";
        ...
        <div className="container mx-auto py-8">
            ...
            <nav className="mb-4">
                <Breadcrumb >
                    ...
                    <Breadcrumb.Item>
                        <Link to="/checkout" className="text-gray-500">Thông tin giao hàng</Link>
                    </Breadcrumb.Item>
                    <Breadcrumb.Item>
                        <Link to="/payment" className="text-gray-500">Phương thức thanh toán</Link>
                    </Breadcrumb.Item>
                </Breadcrumb>
            </nav>
